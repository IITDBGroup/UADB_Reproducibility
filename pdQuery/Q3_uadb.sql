...
(
(SELECT n_name, o_orderkey, least(least(c.u_r,o.u_r),n.u_r) as u_r FROM customer_uadb c, orders_uadb o, nation_uadb n WHERE c_nationkey = n_nationkey AND c_custkey = o_custkey AND n_name = 'IRAQ') u1 
JOIN 
