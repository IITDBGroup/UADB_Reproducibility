...
(select tid,n_name from nation_n_name where w1=1) c2 join (select min(w1) as w1,tid from nation_n_name group by tid) o2 on c2.tid=o2.tid) l2 on l1.tid=l2.tid
JOIN
